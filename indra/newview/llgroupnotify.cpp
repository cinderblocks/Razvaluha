	...
	mInventoryOffer(NULL)
{
	...
	static const LLStyleSP headerstyle(new LLStyle(true,LLColor4::black,"SANSSERIF_BIG"));
	static const LLStyleSP datestyle(new LLStyle(true,LLColor4::black,"SANSSERIF"));
