...
{
    std::string url = getRegion() ? getRegion()->getCapability(capName) : LLStringUtil::null;
...
void LLAgent::sendAgentSetAppearance()
{
	...
	const LLVector3 body_size = gAgentAvatarp->mBodySize + gAgentAvatarp->getLegacyAvatarOffset();
