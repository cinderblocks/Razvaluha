...
BOOL LLPanelGeneral::postBuild()
{
	...
	crash_behavior_combobox->setCurrentByIndex(gSavedSettings.getS32("CrashSubmitBehavior"));
...
void LLPanelGeneral::apply()
{
	...
	LLComboBox* crash_behavior_combobox = getChild<LLComboBox>("crash_behavior_combobox");
	gSavedSettings.setS32("CrashSubmitBehavior", crash_behavior_combobox->getCurrentIndex());
}
