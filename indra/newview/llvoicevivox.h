...
protected:
	...
	typedef std::vector<participantStatePtr_t> participantList;
    ...
    public:
		...
		void removeParticipant(const participantStatePtr_t &participant) { removeParticipant(participant->mURI); }
