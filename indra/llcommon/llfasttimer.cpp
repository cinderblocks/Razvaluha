...
void LLFastTimer::pushLog(LLSD log)
{
...
void LLFastTimer::setLogLock(LLMutex* lock)
{
	sLogLock = lock;
}
...
// static
LLFastTimer::NamedTimer& LLFastTimer::NamedTimer::getRootTimeBlock()
{ 
